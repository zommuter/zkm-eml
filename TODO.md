...
- [ ] Run --reprocess on ~/knowledge to apply v0.7 quote stripping (user-triggered)
...
- [x] Run --reprocess on ~/knowledge — 30125 files rewritten to v0.6.0 — 2026-05-06
- [x] v0.7 quote stripping: full tail-quote collapse (≥90% similarity), English/German attribution detection, nested chain support, EML_QUOTE_STRIP knob, round-trip guarantee via originals — covered by tests (103/103 passing) on 2026-05-07
